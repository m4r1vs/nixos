...
''
  ...
  ) | ${pkgs.rofi-wayland}/bin/rofi -dmenu -show-icons -multi-select -i -display-columns 2 -theme-str "entry{placeholder:\"  Clipboard...\";}element{children:[element-text,element-icon];}" -ballot-selected-str " " -ballot-unselected-str " ")
