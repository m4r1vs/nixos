    ...
    home.file.".config/waybar/style-light.css".text =
      ...
      */
      ''
        ...
        @define-color wb-act-bg ${theme.primaryColor};
      ...
      settings = {
        mainBar = {
          ...
          "custom/notifications" = {
            ...
            format = "{icon}";
            format-icons = {
              notification = "<span foreground='${theme.primaryColor}'><sup></sup></span>";
              none = "";
              dnd-notification = "<span foreground='${theme.primaryColor}'><sup></sup></span>";
              dnd-none = "";
              inhibited-notification = "<span foreground='${theme.primaryColor}'><sup></sup></span>";
              inhibited-none = "󰮯";
              dnd-inhibited-notification = "<span foreground='${theme.primaryColor}'><sup></sup></span>";
          ...
          network = {
            ...
            format = "<span foreground='${theme.primaryColor}'> {bandwidthDownBytes}</span> <span foreground='${theme.secondaryColor}'> {bandwidthUpBytes}</span>";
            interval = 2;
          };
